...
providers (see 2.1.), the financing opportunities in statistical systems (see 2.2.), the overall statistical
performance in recipient countries (see 2.3.) and the specific sectoral support to gender data and
statistics (see 2.4.).
...
as captured by ODA commitments, described in section 2.1, gender data financing opportunities in
